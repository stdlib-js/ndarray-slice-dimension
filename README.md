...
```javascript
import sliceDimension from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-slice-dimension@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-slice-dimension/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/ndarray-slice-dimension/actions/workflows/test.yml?query=branch:v0.2.2
